...
<div class="form-box">
      ...
      <div class="alert alert-danger" id="alert_1" style="background-color: #de1313; color: white; display:none;" >
        <strong>The username and password doesn't match</strong>
            ...
            <form class="input-group"  style ="top:100px;"id="register" action="student_login.php" method="post">
                ...
                <input type="password" name="password" class="input-field" placeholder="Enter Password" required>
                <input type="text" name="roll"class="input-field" placeholder="Roll no" required>
