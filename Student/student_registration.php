...
#first_name { background-position: 10px 10px !important }
#last_name { background-position: 10px 10px !important }
#username { background-position: 10px 10px !important }
#password { background-position: 10px -53px !important }
#roll_no { background-position: 10px 10px !important }
#email { background-position: 10px 10px !important }
#phone_no { background-position: 10px 10px !important }
...
<div class="container">
  <section id="content">
    <form name="Registration" action="" method="post">
      ...
      <div>
        <input type="text" name="first" placeholder="First Name" required="" id="first_name" />
      </div>
      <div>
        <input type="text" name="last" placeholder="Last Name" required="" id="last_name" />
      </div>
      <div>
      ...
      <div>
        <input type="number" name="roll" placeholder="Roll No" required="" id="roll_no" />
      </div>
      <div>
        <input type="text" name="email" placeholder="Email" required="" id="email" />
      </div>
      <div>
        <input type="text" name="contact" placeholder="Phone No" required="" id="phone_no" />
      </div>
      <div>
